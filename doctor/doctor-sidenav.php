    ...
    <!-- SideNav Begins -->
     <div class="sidenav">
        ...
        <div class="sidebar list-group bg-lavender">
            <a class="list-group-item list-group-item-action bg-lavender text-center" data-parent="dashboard" href="../doctor/doctor-index.php?tab_id=<?php echo $tab_id; ?>" title="Dashboard">
                <span class="icon"><i class="ri-layout-grid-line"></i></span>
                <span class="sidebar--item">Dashboard</span>
            </a>
            <a class="list-group-item list-group-item-action bg-lavender text-center" data-parent="profile" href="../doctor/doctor-profile.php?tab_id=<?php echo $tab_id; ?>" title="Profile">
                <span class="icon"><i class="ri-user-3-fill"></i></span>
                <span class="sidebar--item">Profile</span>
            </a>
            <a class="list-group-item list-group-item-action bg-lavender text-center" data-parent="patient" href="../doctor/doctor-patient.php?tab_id=<?php echo $tab_id; ?>" title="Patients">
                <span class="icon"><i class="ri-hotel-bed-fill"></i></span>
                <span class="sidebar--item">Patients</span>
            </a>
            <a class="list-group-item list-group-item-action bg-lavender text-center" data-parent="appointment" href="../doctor/appointment.php?tab_id=<?php echo $tab_id; ?>" title="Appointment">
                <span class="icon"><i class="ri-calendar-fill"></i></span>
                <span class="sidebar--item">Appointment</span>
            </a>
         
            <a class="list-group-item list-group-item-action bg-lavender text-center" data-parent="report" href="../doctor/doctor-report.php?tab_id=<?php echo $tab_id; ?>" title="Reports">
                <span class="icon"><i class="ri-article-fill"></i></span>
                <span class="sidebar--item">Reports</span>
            </a>

           <a class="list-group-item list-group-item-action bg-lavender text-center" data-parent="support" href="../doctor/doctor-support.php?tab_id=<?php echo $tab_id; ?>" title="Support">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const parentMap = {
        ...
        "schedule.php": "dashboard",

        "doctor-profile.php": "profile",

        "appointment.php": "appointment",
        "discharge.php": "appointment",

        "doctor-patient.php": "patient",
        "doctor-view.php": "patient",
        "add-data.php": "patient",
        "doctor-report.php": "report",
       
        



        "doctor-support.php": "support",
        "faq.php": "support",
