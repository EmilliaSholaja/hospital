...
<!-- SideNav Begins -->
<div class="sidenav">
    <?php $tab_id = $_GET['tab_id'] ?? ''; ?>
    <div class="sidebar list-group bg-lavender">
        <a class="list-group-item list-group-item-action bg-lavender text-center" data-parent="dashboard" href="./index.php?tab_id=<?php echo $tab_id; ?>" title="Dashboard">
            <span class="icon"><i class="ri-layout-grid-line"></i></span>
            <span class="sidebar--item">Dashboard</span>
        </a>
        <a class="list-group-item list-group-item-action bg-lavender text-center" data-parent="profile" href="../admin/profile.php?tab_id=<?php echo $tab_id; ?>" title="Profile">
            <span class="icon"><i class="ri-user-3-fill"></i></span>
            <span class="sidebar--item">Profile</span>
        </a>
        <a class="list-group-item list-group-item-action bg-lavender text-center" data-parent="admin" href="../admin/admin.php?tab_id=<?php echo $tab_id; ?>" title="Administrator">
            <span class="icon"><i class="ri-user-2-fill"></i></span>
            <span class="sidebar--item">Administrator</span>
        </a>
        <a class="list-group-item list-group-item-action bg-lavender text-center" data-parent="doctor" href="doctor.php?tab_id=<?php echo $tab_id; ?>" title="Doctors">
            <span class="icon"><i class="ri-medicine-bottle-fill"></i></span>
            <span class="sidebar--item">Doctors</span>
        </a>
        <a class="list-group-item list-group-item-action bg-lavender text-center" data-parent="patient" href="patient.php?tab_id=<?php echo $tab_id; ?>" title="Patients">
            <span class="icon"><i class="ri-hotel-bed-fill"></i></span>
            <span class="sidebar--item">Patients</span>
        </a>
        <a class="list-group-item list-group-item-action bg-lavender text-center" data-parent="support" href="../admin/admin-support.php?tab_id=<?php echo $tab_id; ?>" title="Support">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const parentMap = {
        "index.php": "dashboard",
        "income.php": "dashboard",
        "job-request.php": "dashboard",
