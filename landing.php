  ...
  <body>
      ...
      <nav class="section__container nav__container">
        ...
        <ul class="nav__links">
         <li class="link"><a href="#home">Home</a></li>
          ...
          <li class="link"><a href="https://www.lifebridgehealth.org/blogs?utm_source=chatgpt.com">Blog</a></li>
          <li class="link"><a href="patient-login.php">Login</a></li>
        </ul>
      ...
      <div class="section__container header__container" id="home">
        ...
        <div class="header__form">
          <form>
            ...
            <button type="submit" onclick="location.href='patient-register.php'" class="btn form__btn">Book Appointment</button>
          </form>
        </div>
      </div>
    </header>
    ...
    <section class="section__container doctors__container" id="doctor">
      ...
      <div class="doctors__grid">
        ...
        <div class="doctors__card">
          <div class="doctors__card__image">
            <img src="./images/doctor-4.jpg" alt="doctor" />
            <div class="doctors__socials">
              <span><i class="ri-instagram-line"></i></span>
              <span><i class="ri-facebook-fill"></i></span>
              <span><i class="ri-heart-fill"></i></span>
          ...
          <h4>Dr. Alexander Brown</h4>
          <p>Ophthalmologist</p>
        </div>
        <div class="doctors__card">
          <div class="doctors__card__image">
            <img src="./images/doctor-5.jpg" alt="doctor" />
            <div class="doctors__socials">
              <span><i class="ri-instagram-line"></i></span>
              <span><i class="ri-facebook-fill"></i></span>
              <span><i class="ri-heart-fill"></i></span>
          ...
          <h4>Dr. Winifred Taylor</h4>
          <p>Pediatrician</p>
        </div>
        <div class="doctors__card">
          <div class="doctors__card__image">
            <img src="./images/doctor-6.jpg" alt="doctor" />
            <div class="doctors__socials">
              <span><i class="ri-instagram-line"></i></span>
              <span><i class="ri-facebook-fill"></i></span>
              <span><i class="ri-heart-fill"></i></span>
    ...
    <section class="review" id="review">
      ...
      <h1 class="section__header"> Client's <span>Review</span> </h1>
      <p>Here's what some of our patients have to say about their experience at our hospital:</p>
      ...
      <div class="box-container">
          ...
          <div class="box">
            <div class="row">
              ...
              <p class="text">"I was nervous about my surgery, but the staff at this hospital put me at ease. They were friendly, efficient, and made sure I had everything I needed. The facilities were top-notch too!"</p>
          </div>
          ...
          <div class="box">
            <div class="row">
              ...
              <p class="text">"I had a wonderful experience giving birth at this hospital! The nurses were so supportive and caring, and the hospital room was comfortable and clean. I'd definitely recommend this hospital to others!"</p>
          </div>
          ...
          <div class="box">
            <div class="row">
              ...
              <p class="text">"I was impressed by the level of care I received at this hospital. The doctors and nurses were knowledgeable, friendly, and made sure I understood everything that was happening. I'd definitely come back here if I needed medical care again!"</p>
          </div>
    ...
    <footer class="footer">
      <div class="section__container footer__container">
        ...
        <div class="footer__col">
          <h4>Contact Us</h4>
          <p>
            <i class="ri-map-pin-2-fill"></i> 123, Lagos Island Lagos, Nigeria
          </p>
          <p><i class="ri-mail-fill"></i> sholajaemillia@gmail.com</p>
          <p><i class="ri-phone-fill"></i> +234 811 723 6502</p>
        </div>
      </div>
      <div class="footer__bar">
        <div class="footer__bar__content">
          <p>Copyright © 2025 Sholaja Emillia. All rights reserved.</p>
